...
public class PlayerTest {
    public static void main(String[] args) {
        ...
        Inimigo inimigo = new Inimigo("Inimigo 1", 50);
        ...
        Item kit = new Item("Kit Básico", 20, EItemTipo.KIT);
        ...
        Item colete = new Item("Colete Básico", 30, EItemTipo.COLETE);
        System.out.println("\n--- Teste de apanhar item (COLETE) ---");
        player.apanharItem(colete); // O colete deve ser equipado
        Item colete2 = new Item("Colete Básico",30, EItemTipo.COLETE);
        System.out.println("\n--- Teste de apanhar item (COLETE) ---");
